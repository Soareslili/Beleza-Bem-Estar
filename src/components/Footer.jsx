        ...
        <section className="container mx-auto px-4 py-16 bg-black">
            <div className="grid md:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col">
                    ...
                    <a className=" w-[250px] bg-rose-600 text-white py-3 rounded-full cursor-pointer hover:bg-rose-700 transition-all duration-300 shadow-lg text-center transform hover:scale-105 hover:translate-z-0">Agendar pelo whatsapp</a>
                </div>
